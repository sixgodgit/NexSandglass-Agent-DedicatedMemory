...
> **V2.9 Infinite Context:** 30 topic anchors + drift velocity + thread knowledge graph + weave machine + soul distillation. Hermes-independent. Fully local.
...
### V2.8→V2.9「无限上下文」(2026-06)
```
四路并发搜索 + 明文落沙 + density×trust统一公式 + 锚点引擎30条
